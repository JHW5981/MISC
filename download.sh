...
case $dataset_name in
    grotoap2)
        download_compiled_dataset "grotoap2" $GROTOAP2_S3_NAME
        ;;
    docbank)
        download_compiled_dataset "docbank" $DOCBANK_S3_NAME
        ;;
    s2-vl)
        download_compiled_dataset "s2-vl-ver1" $S2_VL_VER1_S3_NAME
        ;;
    all)
        download_compiled_dataset "grotoap2" $GROTOAP2_S3_NAME
        download_compiled_dataset "docbank" $DOCBANK_S3_NAME
